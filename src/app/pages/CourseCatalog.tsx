...
export function CourseCatalog() {
  ...
  const filteredCourses = useMemo(() => {
    ...
    // Secretary only sees their own department. The backend provides the
    // user's department_id (Account.department_id) which matches DbCourse.department_id.
    if (currentUser.role === 'secretary' && currentUser.department_id != null) {
