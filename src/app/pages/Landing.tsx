...
const ROLES = [
  {
    ...
    sublabel: 'Dean & Secretariat',
    description: 'View the full programme at a glance, manage sections, and publish the final schedule.',
    features: ['Full weekly grid view', 'Section management & resolution', 'Publish & export'],
    ...
    >
      ...
      >
        <div
          ...
          onMouseLeave={e => {
            (e.currentTarget as HTMLElement).style.boxShadow = darkMode ? 'none' : '0 1px 3px rgba(0,0,0,0.06)';
            (e.currentTarget as HTMLElement).style.borderColor = darkMode ? '#1e293b' : '#e2e8f0';
          }}
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <span
                style={{ fontSize: '11px', color: darkMode ? '#64748b' : '#94a3b8' }}
              >
                Browse 962 courses across 12 departments
              </span>
            </div>
          </div>
          <ArrowRight
